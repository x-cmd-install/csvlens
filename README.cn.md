...
[![x-cmd/install — csvlens Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/csvlens.svg?lang=zh)](https://x-cmd.com/install/csvlens)
...
合计: **8,634** 行代码（覆盖前 5 种语言、共 **32** 个文件）。
...
- **Star**: 3,983 · **Fork**: 71 · **开放 issue**: 130 · **贡献者**: 22

## 累计统计

- **发布数**: 18 · **已合并 PR**: 62 · **开放 PR**: 9 · **已关闭 issue**: 80 · **开放 issue**: 50 · **提交数**: 467
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/csvlens.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260924.yml` · 2026-09-24T05:40:18Z._
